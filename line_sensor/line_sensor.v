...
//   output [11:0]d_out_ch5,	//12-bit output of ch. 5 (parallel)
	output [0:11]d_out_ch6,	//12-bit output of ch. 6 (parallel)
...
always@(posedge adc_sck)begin        // store DATA to send 
case(sck_counter)

5:  data_store[11]=dout;
6:  data_store[10]=dout;
7:  data_store[9]=dout;
8:  data_store[8]=dout;
9:  data_store[7]=dout;
10: data_store[6]=dout;
11: data_store[5]=dout;
12: data_store[4]=dout;
13: data_store[3]=dout;
14: data_store[2]=dout;
15: data_store[1]=dout;
16: data_store[0]=dout;
...
assign sensor_1=(ch6<threshold)?1:0;
